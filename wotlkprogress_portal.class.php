	...
	public function get_settings($state){
		$settings	= array(
			...
			'boss7'	=> array(
				...
				'options'	=> array(
					'wotlk_notreleased'	=> $this->user->lang('wotlk_notreleased'),
					'wotlk_0_9'	=> $this->user->lang('wotlk_0_9'),
					'wotlk_1_9'	=> $this->user->lang('wotlk_1_9'),
					'wotlk_2_9'	=> $this->user->lang('wotlk_2_9'),
					'wotlk_3_9'	=> $this->user->lang('wotlk_3_9'),
					'wotlk_4_9'	=> $this->user->lang('wotlk_4_9'),
					'wotlk_5_9'	=> $this->user->lang('wotlk_5_9'),
					'wotlk_6_9'	=> $this->user->lang('wotlk_6_9'),
					'wotlk_7_9'	=> $this->user->lang('wotlk_7_9'),
					'wotlk_8_9'	=> $this->user->lang('wotlk_8_9'),
					'wotlk_clear'	=> $this->user->lang('wotlk_clear'),
				),
			),	
			#Raid 8 Ruby
